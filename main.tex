...
\eq{\dot{q}\geq& \Delta {q}+T\ast\n q+2\left(u-Cn\right)q+2tCH^2.}
Therefore, by the maximum principle, $q$ remains positive and we recover the Harnack inequality (with the bonus term) of \cite{}.
}
...
\Theo{thm}{Hyperbolic}{Let $N=\H^{n+1}$ and let $F$ be a monotone, 1-homogeneous and inverse convex curvature function. Let $p\geq 1$ and set $f=-F^{-p}.$ Along the expanding flow
\eq{\dot{x}=-f\nu}
there holds
\eq{\del_t\br{ft^{\fr{p}{p+1}}}\leq 0.}
