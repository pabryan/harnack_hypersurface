...
With the assumptions of \Cref{Ev-u-2}, suppose that $\-Rc = K_0 g$ with $K_0 \geq 0$, and that the last two lines of equation \eqref{eq:dtu} are non-negative. Then,
